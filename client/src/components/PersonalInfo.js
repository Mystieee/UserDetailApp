    ...
    return (
      <div className="form-container">
        ...
        <form className="form-horizontal">
          ...
          <div className="form-group row">
            <label htmlFor="mobile_number" className="control-label col-sm-4">
              Mobile Number*
            </label>
            <div className="col-sm-6">
              <input
          ...
          <div className="form-group row">
            <label htmlFor="address_line1" className="control-label col-sm-4">
              Address Line1*
            </label>
            <div className="col-sm-6">
              <input
          ...
          <div className="form-group row">
            <label htmlFor="address_line2" className="control-label col-sm-4">
              Address Line2
            </label>
            <div className="col-sm-6">
              <input
          ...
          <div className="form-group row">
            <label htmlFor="address_line3" className="control-label col-sm-4">
              Address Line3
            </label>
            <div className="col-sm-6">
              <input
